...
void discostrobe()
{
  ...
  fill_solid( Vir_led, NUM_LEDS, CRGB::Black);
...
// End DiscoStrobeWithPalette

// ******************** inicio de palette example ********************
...
void paletteWaves()
{
  ...
  colorwaves( leds[0], NUM_LEDS_PER_STRIP, gCurrentPalette);
  colorwaves(leds[1], NUM_LEDS_PER_STRIP, gCurrentPalette);
  colorwaves(leds[2], NUM_LEDS_PER_STRIP, gCurrentPalette);
}
